...
Two prompts are used in sequence:
  ...
  build_suggestion() — sent to the configured LLM (Anthropic / Ollama) to
      generate a human-readable fix suggestion posted as a GitHub Issue comment.
...
def build_tdd(
    ...
    Args:
        ...
        fix_suggestion: The fix suggestion generated by build_suggestion() and
                        ...
                        point on the first iteration — do not blindly copy it.
